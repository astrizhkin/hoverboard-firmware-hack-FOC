...
#define BAT_LIFEPO4 //define chemistry 

#ifdef BAT_LIION
  #define BAT_CELLS               10        // battery number of cells. Normal Hoverboard battery: 10s liion/12s lifepo4
...
#ifdef BAT_LIFEPO4
  #define BAT_CELLS               12        // battery number of cells. Normal Hoverboard battery: 10s liion/12s lifepo4
  #define BAT_LVL5                (330 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // Green blink:  no beep
  #define BAT_LVL4                (290 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // Yellow:       no beep
  #define BAT_LVL3                (270 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // Yellow blink: no beep 
  #define BAT_LVL2                (260 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // Red:          gently beep at this voltage level. [V*100/cell]. In this case 3.60 V/cell
  #define BAT_LVL1                (250 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // Red blink:    fast beep. Your battery is almost empty. Charge now! [V*100/cell]. In this case 3.50 V/cell
  #define BAT_DEAD                (240 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // All leds off: undervoltage poweroff. (while not driving) [V*100/cell]. In this case 3.37 V/cell
#endif
...
#define TEMP_WARNING            650       // annoying fast beeps [°C * 10].  Here 65.0 °C
#define TEMP_POWEROFF_ENABLE    0         // to poweroff or not to poweroff, 1 or 0, DO NOT ACTIVITE WITHOUT CALIBRATION!
#define TEMP_POWEROFF           750       // overheat poweroff. (while not driving) [°C * 10]. Here 75.0 °C
// ######################## END OF TEMPERATURE ###############################
