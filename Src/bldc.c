...
int16_t        batVoltage       = BAT_LVL5;
static int32_t batVoltageFixdt  = BAT_LVL5 << 16;  // Fixed-point filter output initialized at 400 V*100/cell = 4 V/cell converted to fixed-point
